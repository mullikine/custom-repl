...
/* package custom-repl-0.1.0.0 */
#ifndef VERSION_custom_repl
#define VERSION_custom_repl "0.1.0.0"
#endif /* VERSION_custom_repl */
#ifndef MIN_VERSION_custom_repl
#define MIN_VERSION_custom_repl(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_custom_repl */
...
#define CURRENT_COMPONENT_ID "custom-repl-0.1.0.0-inplace-custom-repl"
